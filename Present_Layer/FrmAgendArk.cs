    ...
    public partial class FrmAgendArk : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Edit == true)
            {
                try
                {
                    tools.Edit_Contact(tbxName.Text, tbxLastname.Text, dtpFechaN.Value, tbxAdress.Text, Convert.ToString(cbxGenero.SelectedValue)/*Value to comboboxes*/, Convert.ToString(cbxEstado_c.SelectedValue), tbxPhone.Text, tbxEmail.Text, idContact);
